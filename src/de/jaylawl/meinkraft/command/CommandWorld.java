...
public class CommandWorld implements MeinkraftCommand {
    ...
    public static final String PERMISSION_NODE = "mk.world";
    public static final String PERMISSION_NODE_SELF = "mk.world.self";
    public static final String PERMISSION_NODE_OTHERS = "mk.world.others";
